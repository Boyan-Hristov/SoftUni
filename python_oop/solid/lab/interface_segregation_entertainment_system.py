...
class Television(EntertainmentDevice, RCAConnect, HDMIConnect):
...
class DVDPlayer(EntertainmentDevice, HDMIConnect):
...
class GameConsole(EntertainmentDevice, HDMIConnect, EthernetConnect):
...
class Router(EntertainmentDevice, EthernetConnect):
    def connect_to_tv(self, television):
