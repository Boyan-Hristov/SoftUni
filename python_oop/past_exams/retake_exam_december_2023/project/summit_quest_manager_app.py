...
class SummitQuestManagerApp:
    ...
    def register_climber(self, climber_type: str, climber_name: str):
        if climber_type not in self.VALID_CLIMBERS.keys():
    ...
    def peak_wish_list(self, peak_type: str, peak_name: str, peak_elevation: int):
        if peak_type not in self.VALID_PEAKS.keys():
    ...
    def check_gear(self, climber_name, peak_name: str, gear: List[str]):
    ...
    def perform_climbing(self, climber_name: str, peak_name: str):
        ...
        climber.rest()  # check if it is needed to call the method
    ...
    def get_statistics(self):
        ...
        for c in self.climbers:
            total_peaks_climbed.extend(c.conquered_peaks)
        # total_peaks_climbed.extend([c.conquered_peaks for c in self.climbers])
        total_peaks_climbed = set(total_peaks_climbed)
        result.append(f"Total climbed peaks: {len(total_peaks_climbed)}")
